...
public:
    ...
    /**
     * Put a color inverted char on the screen
     *
     * @param value char to print
     * @returns printed char
     */
    virtual int _putcI(int value);
    /**
    ...
    /**
     * Draw a inverted color character on given position out of the active font to the LCD
     *
     * @param x x-position of char (top left)
     * @param y y-position
     * @param c char to print
     */
    virtual void characterI(int x, int y, int c);
    /**
